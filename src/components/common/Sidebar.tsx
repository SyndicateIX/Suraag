...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen = false, onClose }) => {
  ...
  const navGroups = [
    {
      ...
      items: [
        ...
        { name: 'Data Ingestion', path: '/data-ingestion', icon: Vault },
      ],
    },
    {
  ...
  return (
    <>
      ...
      <aside className={`fixed left-0 top-16 bottom-0 z-50 w-[86vw] max-w-72 bg-surface/95 backdrop-blur-2xl border-r border-outline-variant/40 flex flex-col justify-between shadow-[4px_0_20px_rgba(0,0,0,0.5)] transition-transform duration-300 ease-out ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:w-64 lg:z-30`}>
