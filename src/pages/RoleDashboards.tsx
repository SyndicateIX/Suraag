...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="p-8 text-center mt-20">
      <h1 className="text-3xl font-display-lg font-bold text-primary mb-4">Director / Head Command Center</h1>
...
export const OfficerDashboard: React.FC = () => {
  ...
  return (
    <div className="p-8 text-center mt-20">
      <h1 className="text-3xl font-display-lg font-bold text-primary mb-4">Senior Officer Dashboard</h1>
...
export const InvestigatorDashboard: React.FC = () => {
  ...
  return (
    <div className="p-8 text-center mt-20">
      <h1 className="text-3xl font-display-lg font-bold text-primary mb-4">Investigator Dashboard</h1>
...
export const EvidenceDashboard: React.FC = () => {
  ...
  return (
    <div className="p-8 text-center mt-20">
      <h1 className="text-3xl font-display-lg font-bold text-primary mb-4">Evidence Dashboard</h1>
...
export const DigitalDashboard: React.FC = () => {
  ...
  return (
    <div className="p-8 text-center mt-20">
      <h1 className="text-3xl font-display-lg font-bold text-primary mb-4">Digital Forensics Dashboard</h1>
